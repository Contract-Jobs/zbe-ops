...
export const users: User[] = [
  { id: "usr_abebe", name: "Abebe Tadesse", role: "admin", siteIds: [] },
...
export const warehouses: Warehouse[] = [
  {
    id: "wh_bole",
    name: "Bole central yard",
    location: "Bole Sub City, Addis Ababa",
    createdAt: t("2021-03-12T08:00:00Z"),
  },
  {
    id: "wh_kaliti",
    name: "Kaliti store",
    location: "Nifas Silk-Lafto, Addis Ababa",
    createdAt: t("2023-01-18T08:00:00Z"),
  },
];
...
export const sites: Site[] = [
  {
    ...
    updatedAt: t("2025-11-02T08:00:00Z"),
    deletedAt: null,
  },
  {
    id: "site_ebc",
    ...
    updatedAt: t("2026-02-14T08:00:00Z"),
    deletedAt: null,
  },
  {
    id: "site_factory",
    ...
    updatedAt: t("2025-08-20T08:00:00Z"),
    deletedAt: null,
  },
];
...
export const siteLifecycle: SiteLifecycleLog[] = [
  {
    id: "lc1",
    siteId: "site_westin",
    note: "Site opened. Mobilisation complete.",
    createdAt: t("2025-11-02T08:00:00Z"),
    loggedBy: "usr_abebe",
  },
  {
    id: "lc2",
    siteId: "site_westin",
    note: "Material budget raised after guest-floor addendum.",
    createdAt: t("2026-04-11T08:00:00Z"),
    loggedBy: "usr_abebe",
  },
  {
    id: "lc3",
    siteId: "site_factory",
    note: "Paused pending client power availability.",
...
export const tasks: Task[] = [
  { id: "tsk_1", siteId: "site_westin", title: "Pull 4th-floor lighting trunks", body: "Guest rooms 401–428.", targetDate: t("2026-08-28T00:00:00Z"), isCompleted: false, completionClaimBy: null, notes: null, completedDate: null, createdAt: t("2026-08-10T08:00:00Z") },
  { id: "tsk_2", siteId: "site_westin", title: "Panel P-L2 termination", targetDate: t("2026-08-22T00:00:00Z"), isCompleted: false, completionClaimBy: "usr_hana", notes: "Claimed today", completedDate: null, createdAt: t("2026-08-08T08:00:00Z") },
  { id: "tsk_3", siteId: "site_westin", title: "Main incomer IR test", targetDate: t("2026-08-15T00:00:00Z"), isCompleted: true, completionClaimBy: "usr_hana", notes: "Done", completedDate: t("2026-08-15T12:00:00Z"), reviewNotes: "Readings filed. Passed.", createdAt: t("2026-08-01T08:00:00Z") },
  { id: "tsk_4", siteId: "site_ebc", title: "Rack grounding grid", targetDate: t("2026-09-02T00:00:00Z"), isCompleted: false, completionClaimBy: null, notes: null, completedDate: null, createdAt: t("2026-08-18T08:00:00Z") },
];

export const materials: Material[] = [
  {
    id: "mat_nyy",
    name: "NYY 4×25 mm² cable",
    unit: "m",
    type: "single",
    categoryId: "cat_cable",
    createdAt: t("2024-01-10T08:00:00Z"),
  },
  {
    id: "mat_mcb",
    name: "MCB 32A 1P",
  ...
  },
  {
    ...
    unit: "m",
    type: "single",
    categoryId: "cat_panel",
    createdAt: t("2024-01-10T08:00:00Z"),
  },
  {
    id: "mat_pvc",
    name: "PVC conduit 25 mm",
    unit: "m",
    type: "single",
    categoryId: "cat_contain",
    createdAt: t("2024-02-02T08:00:00Z"),
  },
  {
    id: "mat_board",
    name: "Floor DB set — 12 way",
    unit: "set",
    type: "set",
    categoryId: "cat_panel",
    createdAt: t("2024-05-16T08:00:00Z"),
  },
  {
    id: "mat_cat6",
    name: "Cat6 UTP drum",
    ...
    type: "single",
    categoryId: "cat_ict",
    createdAt: t("2024-09-01T08:00:00Z"),
  },
];
...
export const materialLogs: MaterialLog[] = [
  {
    ...
    toKind: "warehouse",
    toId: "wh_bole",
    createdAt: t("2026-03-04T08:00:00Z"),
    loggedBy: "usr_abebe",
    isReversal: false,
  },
  {
    ...
    toKind: "site",
    toId: "site_westin",
    createdAt: t("2026-06-12T08:00:00Z"),
    loggedBy: "usr_abebe",
    isReversal: false,
  },
  {
...
export const equipment: Equipment[] = [
  {
    id: "eq_gen",
    name: "Perkins 45 kVA generator",
    serialNumber: "PK-45-8841",
    warehouseId: "wh_bole",
    licenseId: "lic_elec",
    status: "available",
    ...
    value: 980000,
    isOnLoan: false,
    createdAt: t("2023-04-01T08:00:00Z"),
  },
  {
    id: "eq_lift",
    name: "Scissor lift 8 m",
    serialNumber: "SL-08-221",
    siteId: "site_westin",
    licenseId: "lic_elec",
    status: "deployed",
    ownershipStatus: "rented_in",
    value: 0,
    rentRate: 4500,
    isOnLoan: true,
    createdAt: t("2026-07-01T08:00:00Z"),
  },
  {
    id: "eq_tracer",
    name: "Cable tracer kit",
    serialNumber: "CT-19-04",
    siteId: "site_ebc",
    licenseId: "lic_ict",
    status: "deployed",
    ownershipStatus: "owned",
    value: 42000,
    isOnLoan: false,
    createdAt: t("2024-11-20T08:00:00Z"),
  },
  {
    id: "eq_drill",
    name: "Hilti TE 70",
    serialNumber: "HT-70-1190",
    warehouseId: "wh_kaliti",
    licenseId: "lic_elec",
    status: "maintenance",
    ownershipStatus: "owned",
    value: 86000,
    isOnLoan: false,
    createdAt: t("2022-09-14T08:00:00Z"),
  },
  {
    id: "eq_megger",
    name: "Insulation tester 1 kV",
    serialNumber: "MG-1K-77",
    siteId: "site_westin",
    licenseId: "lic_elec",
    status: "deployed",
    ownershipStatus: "owned",
    value: 31000,
    isOnLoan: false,
    createdAt: t("2025-01-09T08:00:00Z"),
  },
];
...
export const equipmentLogs: EquipmentLog[] = [
  {
    ...
    toKind: "site",
    toId: "site_westin",
    vendorName: "LiftHire Addis",
    rentStartDate: t("2026-07-01T08:00:00Z"),
    createdAt: t("2026-07-01T08:00:00Z"),
    loggedBy: "usr_abebe",
    isReversal: false,
  },
  {
    ...
    logType: "maintenance_dispatch",
    fromKind: "warehouse",
    fromId: "wh_kaliti",
    createdAt: t("2026-08-18T08:00:00Z"),
    loggedBy: "usr_abebe",
    isReversal: false,
  },
];
...
export const tenders: Tender[] = [
  {
    id: "tn_1",
    name: "Sheraton ballroom electrical rehab",
    licenseId: "lic_elec",
    status: "submitted",
    submissionDate: t("2026-08-30T00:00:00Z"),
    value: 12800000,
    createdAt: t("2026-07-22T08:00:00Z"),
  },
  {
    id: "tn_2",
    name: "National Bank ICT backbone",
    licenseId: "lic_ict",
    status: "draft",
    value: 6400000,
    createdAt: t("2026-08-12T08:00:00Z"),
  },
  {
    id: "tn_3",
    name: "Hawassa industrial feeder",
    licenseId: "lic_elec",
    status: "lost",
    submissionDate: t("2026-03-01T00:00:00Z"),
    value: 21000000,
    createdAt: t("2026-01-15T08:00:00Z"),
  },
];
...
export const transactions: Transaction[] = [
  {
    ...
    siteId: "site_westin",
    categoryId: "cat_rev",
    transactionDate: t("2026-05-02T00:00:00Z"),
    createdAt: t("2026-05-02T00:00:00Z"),
    note: "Westin mobilisation certificate 1",
  ...
  },
  {
    ...
    licenseId: "lic_elec",
    categoryId: "cat_mat",
    transactionDate: t("2026-03-04T00:00:00Z"),
    createdAt: t("2026-03-04T00:00:00Z"),
    note: "NYY 4×25 purchase → Bole yard",
  ...
  },
  {
    ...
    transactionDate: t("2026-08-01T00:00:00Z"),
    createdAt: t("2026-08-01T00:00:00Z"),
    note: "July site wages",
    sourceRefType: "manual",
    isReversal: false,
    loggedBy: "usr_hana",
  },
