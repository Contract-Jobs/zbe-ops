...
`{ id: uuid, materialId: uuid, siteId: uuid | null, warehouseId: uuid | null, quantity: number, avgUnitPrice: string, updatedAt: date }`

### `ProjectLedger`

`{ id: uuid, siteId: uuid, licenseId: uuid, amount: string, description: string | null, sourceRefType: string, sourceRefId: uuid, isReversal: boolean, reversalOfId: uuid | null, timestamp: date, loggedBy: uuid }`

### `SiteTask`

`{ id: uuid, siteId: uuid, title: string, targetDate: date | null, isCompleted: boolean, completionClaimBy: uuid | null, notes: string | null, completedDate: date | null, review: string | null, createdAt: date, updatedAt: date }`

### `Tender`

`{ id: uuid, licenseId: uuid, name: string, location: string | null, estimatedBudget: string | null, status: string, submissionDate: date | null, createdAt: date, updatedAt: date, deletedAt: date | null }`

### `License`

`{ id: uuid, name: string, createdAt: date, deletedAt: date | null }`

### `Warehouse`

`{ id: uuid, name: string, location: string | null, createdAt: date, deletedAt: date | null }`
